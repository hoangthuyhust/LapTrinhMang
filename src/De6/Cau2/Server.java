...
public class Server {
    public static void save(ArrayList<Nha> list, String path){
        try {
            ...
            for(Nha n: list){
                fw.write(n.getSoNha()+"$"+n.getGiaBan()+"$"+n.getTinhTrang()+"\n");
            }
            fw.close();
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            while((s=br.readLine())!=null){
                String[] arr=s.split("\\$");
                if(arr.length==3){
                    Nha n = new Nha(Integer.parseInt(arr[0]), Float.parseFloat(arr[1]), arr[2]);
                    list.add(n);
                }
            }
            br.close();
            ...
            while(true){
                ...
                switch(select){
                    ...
                    case 3:
                        ...
                        for(Nha n2: list){
                            if(s==n2.getSoNha()){
                                if(n2.getTinhTrang().equalsIgnoreCase("True")){
                                    mess="Nha nay da duoc ban";
                                }else{
                                    n2.setTinhTrang("True");
